...
Game.Launch=function()
{
	...
	'<div class="listing">&bull; added over 20 new cookies</div>'+
	...
	Game.Init=function()
	{
		...
		Game.bakeryNameRefresh=function()
		{
			...
			if (!App && name.indexOf('sayswowifyouguessthisthanyoujusthavetelepathicpowersorsomethingorjusthackedthecodegoodjobyoudeservehacks', name.length-('sayswowifyouguessthisthanyoujusthavetelepathicpowersorsomethingorjusthackedthecodegoodjobyoudeservehacks').length) > 0 && !Game.sesame) Game.OpenSesame();
